...
namespace FSG.Serialization
{
    ...
    public class ObjectToInferredTypesConverter : JsonConverter<object>
    {
        ...
        public ObjectToInferredTypesConverter() : this(FloatFormat.Double, UnknownNumberFormat.Error, ObjectFormat.Expando) { }
        public ObjectToInferredTypesConverter(FloatFormat floatFormat, UnknownNumberFormat unknownNumberFormat, ObjectFormat objectFormat)
        {
